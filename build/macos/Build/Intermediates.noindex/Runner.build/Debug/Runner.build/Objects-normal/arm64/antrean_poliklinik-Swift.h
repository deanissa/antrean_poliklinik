...
#ifndef ANTREAN_POLIKLINIK_SWIFT_H
#define ANTREAN_POLIKLINIK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="antrean_poliklinik",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC18antrean_poliklinik11AppDelegate")
...
SWIFT_CLASS("_TtC18antrean_poliklinik17MainFlutterWindow")
